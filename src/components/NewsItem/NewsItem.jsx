...
const NewsItem = ({ article, location }) => {
  ...
  let src = article.id === 'clrds6uk6if5d0but4mf0j8s2' ? 'https://goksirgornagrupa.pl/turystyka/' : page
  src= article.id === 'clruv2b635onz0bw52fn7lohx' && 'https://itgrudziadz.pl/en/must-see-monuments/'
